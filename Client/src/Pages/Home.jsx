        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-softBlue via-lavender to-endPurple">
            <div className="w-full max-w-[2000px] mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-tertiary max-w-2xl mx-auto px-4
                                animate-fade-in-up">
                ...
                <div className="text-center mt-12 px-4">
                    ...
                    <p className="text-lg text-tertiary max-w-3xl mx-auto mb-8">
                        Our platform connects conscious consumers with quality pre-loved fashion.
                        Every purchase helps reduce waste and promotes sustainable living.
                    </p>
                    <button 
