...
const Detail = () => {
    ...
    const handleMinusQuantity = () => setQuantity(prev => prev > 1 ? prev - 1 : 1);
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg space-y-6">
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <button 
                            ...
                            className="bg-[#45b6e6] text-white px-6 py-2 rounded-lg hover:bg-[#184e77] transition-colors"
                        >Add to Cart</button>
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex">
                                {[...Array(5)].map((_, index) => (
                                    <svg 
                                        key={index}
                                        className={`w-5 h-5 ${index < Math.round(product.rating.rate) ? "text-yellow-400" : "text-gray-300"}`}
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
